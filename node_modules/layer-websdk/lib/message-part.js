...
var fileReader = typeof window === "undefined" ? require("filereader") : FileReader;
...
var MessagePart = (function (_Root) {
  ...
  function MessagePart(options) {
    ...
    _get(Object.getPrototypeOf(MessagePart.prototype), "constructor", this).call(this, newOptions);
  ...
  _createClass(MessagePart, {
    ...
    fetchContent: {
      ...
      value: function fetchContent(callback) {
        ...
        if (this._content && !this.isFiring) {
          ...
          this._content.loadContent(type, function (result) {
            return _this._fetchContentCallback(result, callback);
          });
        }
        return this;
      }
    ...
    _fetchContentCallback: {
      value: function _fetchContentCallback(result, callback) {
        var _this = this;
        ...
        if (this.mimeType === "text/plain") {
          (function () {
            ...
            reader.addEventListener("loadend", function () {
              _this._fetchContentComplete(reader.result, callback);
            });
      ...
      value: function fetchStream(callback) {
        ...
        if (this._content.isExpired()) {
          this._content.refreshContent(this._getClient(), function (url) {
            return _this._fetchStreamComplete(url, callback);
          });
        } else {
      ...
      value: function _sendBlob(client) {
        ...
        reader.onloadend = function () {
          ...
          if (base64data.length < 2048) {
            _this.body = base64data;
            _this.body = _this.body.substring(_this.body.indexOf(",") + 1);
            _this.encoding = "base64";
            _this._sendBody(client);
          } else {
            _this._generateContentAndSend(client);
          }
        };
    ...
    _generateContentAndSend: {
      ...
      value: function _generateContentAndSend(client) {
        ...
        client.xhr({
          ...
          _this._processContentResponse(result.data, client);
        });
      }
    },
    _processContentResponse: {
      ...
      value: function _processContentResponse(response, client) {
        ...
        xhr({
          ...
          headers: {
            "Upload-Content-Length": this.size,
            "Upload-Content-Type": this.mimeType } }, function (result) {
          return _this._processContentUploadResponse(result, response, client);
        });
      }
    },
    _processContentUploadResponse: {
...
Object.defineProperty(MessagePart.prototype, "url", {
  ...
  get: function get() {
    ...
    if (this.__url) {
      ...
      return this._content.isExpired() ? "" : this._content.downloadUrl;
    }return "";
  },
