...
module.exports = function (request, callback) {
  ...
  var onload = function onload() {
    ...
    var headers = { "content-type": this.getResponseHeader("content-type") };
  ...
  if (request.data) {
    if (typeof Blob !== "undefined" && request.data instanceof Blob) {
      ...
      for (var _name in request.data) {
        if (request.data.hasOwnProperty(_name)) {
          if (data) data += "&";
          data += _name + "=" + request.data[_name];
        }
      }
    } else {
