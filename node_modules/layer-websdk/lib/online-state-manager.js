...
var OnlineStateManager = (function (_Root) {
  ...
  function OnlineStateManager(options) {
    ...
    _get(Object.getPrototypeOf(OnlineStateManager.prototype), "constructor", this).call(this, options);
    ...
    this.websocketManager.on("message", function () {
  ...
  _createClass(OnlineStateManager, {
    ...
    _scheduleNextOnlineCheck: {
      ...
      value: function _scheduleNextOnlineCheck() {
        ...
        if (this.isDestroyed || !this.isClientReady) {
          return;
    ...
    checkOnlineStatus: {
      ...
      value: function checkOnlineStatus(callback) {
        ...
        xhr({
          ...
          method: "POST",
          headers: {
            accept: "application/vnd.layer+json; version=1.0" } }, function () {
          // this.isOnline will be updated via _connectionListener prior to this line executing
          if (callback) callback(_this.isOnline);
        });
      }
    },
    _changeToOffline: {
