...
var SyncManager = (function (_Root) {
  ...
  function SyncManager(options) {
    ...
    _get(Object.getPrototypeOf(SyncManager.prototype), "constructor", this).call(this, options);
  ...
  _createClass(SyncManager, {
    ...
    _onlineStateChange: {
      ...
      value: function _onlineStateChange(evt) {
        ...
        if (evt.eventName === "connected") {
          setTimeout(function () {
            return _this._processNextRequest();
          }, 100);
    ...
    _findUnfiredCreate: {
      ...
      value: function _findUnfiredCreate(requestEvt) {
        return Boolean(this.queue.filter(function (evt) {
          return evt.target === requestEvt.target && evt.operation === "POST" && !evt.firing;
        }).length);
      }
    },
    _processNextRequest: {
        ...
        if (this.isOnline() && requestEvt && !requestEvt.firing) {
          if (requestEvt instanceof WebsocketSyncEvent) {
            if (this.websocketManager && this.websocketManager._isOpen()) {
              ...
              this.websocketManager.sendRequest(requestEvt._getRequestData(), function (result) {
                return _this._xhrResult(result, requestEvt);
              });
    ...
    _xhrHandleServerUnavailableError: {
      ...
      value: function _xhrHandleServerUnavailableError(request) {
        var maxDelay = this.maxUnavailableRetryWait;
    ...
    _xhrHandleServerError: {
      ...
      value: function _xhrHandleServerError(result) {
    ...
    _xhrValidateIsOnline: {
      ...
      value: function _xhrValidateIsOnline() {
        ...
        this.onlineManager.checkOnlineStatus(function (isOnline) {
          return _this._xhrValidateIsOnlineCallback(isOnline);
        });
      }
    },
    _xhrValidateIsOnlineCallback: {
