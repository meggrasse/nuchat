...
var TypingIndicatorListener = (function (_Root) {
  ...
  function TypingIndicatorListener(args) {
    ...
    _get(Object.getPrototypeOf(TypingIndicatorListener.prototype), "constructor", this).call(this, args);
    ...
    _poll: {
      value: function _poll() {
        ...
        conversationIds.forEach(function (id) {
          ...
          Object.keys(_this.state[id].users).forEach(function (userId) {
            if (Date.now() >= state.users[userId].startTime + 6000) {
              _this._updateState(state, FINISHED, userId);
              delete state.users[userId];
              _this.trigger("typing-indicator-change", {
                conversationId: id,
                typing: state.typing,
                paused: state.paused });
            }
